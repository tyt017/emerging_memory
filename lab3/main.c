...
//		if(gbHostWriteIdle)
		{
			...
			if(dwStatus & ATA_STS_REQ_EXEC_DMAIO_CMD)
			{
				...
				//DMA write command
				if(!pIOInfo->isRead && protectEnable_flag == 0) 
				{
